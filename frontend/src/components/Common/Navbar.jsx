...
const Navbar = () => {
  ...
  return (
    ...
    {/* Mobile Navigation */}
    <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/2 h-full bg-white shadow-lg transition-transform duration-300 z-50 ${navDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}>
