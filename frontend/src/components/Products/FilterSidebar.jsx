...
const FilterSidebar = () => {
  ...
  // You can use database implementation instead of using below variable declarations
    ...
    <div className="p-4">
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {colors.map((color) => (
            // For colors, it is onClick and not onChange because we are using buttons here
            <button
              key={color}
              name="color"
              value={color}
