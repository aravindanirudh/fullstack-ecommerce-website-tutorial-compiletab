    ...
    <section className='py-16 px-4 lg:px-0'>
        <div className='container mx-auto flex flex-col md:flex-row gap-8'>
            ...
            <div className="relative flex-1">
                <img src={womensCollectionImage} alt="Women's collection image" className='w-full h-[700px] object-cover'/>
            ...
            {/* Women's collection */}
            <div className="relative flex-1">
                <img src={mensCollectionImage} alt="Men's collection image" className='w-full h-[700px] object-cover'/>
                <div className='absolute bottom-8 left-8 bg-white/90 p-4'>
